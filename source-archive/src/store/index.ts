...
const initSampleData = () => {
  ...
  const posts: Post[] = [
    {
      ...
      authorClass: 3,
      title: '今天食堂的红烧肉太绝了！',
      content: '今天中午在二食堂吃到了超级好吃的红烧肉，肥而不腻，入口即化！师傅的手艺越来越好了，大家快去尝尝！',
      images: [],
      tag: '伙食',
      visibility: 'school',
    ...
    },
    {
      ...
      authorClass: 7,
      title: '数学笔记分享 - 二次函数',
      content: '整理了最近几节课的数学笔记，关于二次函数的知识点总结，希望对大家有帮助！',
      images: [],
      tag: '笔记',
      visibility: 'grade',
    ...
    },
    {
      ...
      authorId: 'user_3',
      authorName: '小刚',
      authorAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=xiaogang',
      authorYear: 2021,
      authorClass: 5,
      title: '听说下学期要换班主任了？',
      content: '小道消息，听说我们年级下学期要有一些班级调整，具体还不清楚，有人知道更多消息吗？',
      images: [],
      tag: '小道消息',
      visibility: 'grade',
    ...
    },
    {
      ...
      authorClass: 3,
      title: '我们班运动会拿了第一名！',
      content: '太激动了！经过大家的努力，我们班在这次运动会上获得了团体总分第一名！感谢所有参赛的同学！',
      images: [],
      tag: '活动',
      visibility: 'class',
    ...
    },
    {
      ...
      authorClass: 7,
      title: '李老师的语文课太有意思了',
      content: '今天李老师讲古诗词，讲得特别生动，还给我们讲了好多历史背景知识，收获满满！',
      images: [],
      tag: '老师',
      visibility: 'school',
    ...
    },
    {
      ...
      authorClass: 5,
      title: '有人看到我的水杯吗？',
      content: '昨天在操场丢失了一个蓝色保温杯，上面贴了很多贴纸，有看到的同学请联系我，谢谢！',
      images: [],
      tag: '失物招领',
      visibility: 'school',
    ...
    },
    {
      ...
      authorClass: 3,
      title: '出几本二手教辅书',
      content: '毕业了，出一些用过的教辅书，大部分都很新，价格可商量，有兴趣的私聊！',
      images: [],
      tag: '二手交易',
      visibility: 'school',
    ...
    },
    {
      ...
      authorClass: 7,
      title: '隔壁班那个男生...',
      content: '有人认识隔壁班那个经常穿白色卫衣的男生吗？好像是我们年级的学霸...',
      images: [],
      tag: '八卦',
      visibility: 'class',
      createdAt: '2024-12-13T19:30:00Z',
      likes: 0,
      comments: 0,
      views: 0,
      likedBy: [],
  ...
  const defaultTags = ['伙食', '八卦', '老师', '笔记', '小道消息', '活动', '失物招领', '二手交易', '其他'];
